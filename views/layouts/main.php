...
<?php $this->beginBody() ?>
 ...
 NavBar::begin([
 'brandLabel' =>'<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-flower3" viewBox="0 0 16 16">
...
<footer id="footer" class="mt-auto py-3 bg-success text-danger">
    <div class="container">
